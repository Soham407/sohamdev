...
export const metadata: Metadata = {
  title: "sohamdev.studio | Modern Websites for Local Service Businesses",
  description:
    "Modern websites for local service businesses without upfront cost. One monthly fee. Everything handled.",
};
